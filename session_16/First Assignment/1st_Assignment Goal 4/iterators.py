...
# gen = parse_utils.iter_combined_plain_tuple(arguments.fnames, arguments.class_names,
#                                             arguments.parsers, arguments.compress_fields)
#
# print(list(next(gen)))
# print(list(next(gen)))

# nt = parse_utils.create_combo_named_tuple_class(arguments.fnames, arguments.compress_fields)
# print(nt._fields)

# data_iter = parse_utils.iter_combined(arguments.fnames, arguments.class_names,
#                                       arguments.parsers, arguments.compress_fields)
#
...
#
#
# data = parse_utils.filtered_iter_combined(arguments.fnames, arguments.class_names,
#                                           arguments.parsers, arguments.compress_fields,
...
results_f = parse_utils.group_data(arguments.fnames, arguments.class_names,
                                   arguments.parsers, arguments.compress_fields,
                                   filter_key=partial(filter_key, cutoff_date, 'Female'),
                                   group_key=lambda row: row.vehicle_make)

results_m = parse_utils.group_data(arguments.fnames, arguments.class_names,
                                   arguments.parsers, arguments.compress_fields,
